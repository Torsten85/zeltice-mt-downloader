...
var codes = {
	1000: {
		type: error,
		message: 'No download file found on {0}'
	},
	1001: {
		type: error,
	...
	1006: {
		type: error,
		message: '[--file] parameter to [resume] command should contain a valid download file'
	},
	1007: {
		type: error,
	...
	1012: {
		type: error,
		message: 'The download file is corrupt. Start a new download.'
	},
	1013 :{
		type:error,
